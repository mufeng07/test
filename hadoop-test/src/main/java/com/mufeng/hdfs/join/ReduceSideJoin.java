...
public class ReduceSideJoin {
	...
	public static void main(String[] args) throws Exception {
		...
		FileInputFormat.setInputPaths(job, new Path("D:\\transferStation\\tmp\\join\\input"));
		FileOutputFormat.setOutputPath(job, new Path("D:\\transferStation\\tmp\\join\\out1"));
