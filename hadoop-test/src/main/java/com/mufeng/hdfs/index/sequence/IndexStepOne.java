package com.mufeng.hdfs.index.sequence;
...
public class IndexStepOne {
	...
	public static void main(String[] args) throws Exception{
		...
		FileInputFormat.setInputPaths(job, new Path("D:\\transferStation\\tmp\\index\\input"));
		FileOutputFormat.setOutputPath(job, new Path("D:\\transferStation\\tmp\\index\\out-seq-1"));
