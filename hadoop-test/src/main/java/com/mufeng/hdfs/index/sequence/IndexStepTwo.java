...
public class IndexStepTwo {
	...
	public static void main(String[] args) throws Exception{
		...
		FileInputFormat.setInputPaths(job, new Path("D:\\transferStation\\tmp\\index\\out-seq-1"));
		FileOutputFormat.setOutputPath(job, new Path("D:\\transferStation\\tmp\\index\\out3"));
