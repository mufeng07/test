package com.mufeng.hdfs.order.group;
...
public class OrderTopn {
	...
	public static void main(String[] args) throws Exception {
		...
		FileInputFormat.setInputPaths(job, new Path("D:\\transferStation\\tmp\\order\\input"));
		FileOutputFormat.setOutputPath(job, new Path("D:\\transferStation\\tmp\\order\\out-3"));
