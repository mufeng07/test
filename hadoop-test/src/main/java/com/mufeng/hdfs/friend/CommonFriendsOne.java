...
public static void main(String[] args) throws Exception {
		...
		FileInputFormat.setInputPaths(job, new Path("D:\\transferStation\\tmp\\friends\\input"));
		FileOutputFormat.setOutputPath(job, new Path("D:\\transferStation\\tmp\\friends\\out1"));
