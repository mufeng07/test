...
public static void main(String[] args) throws Exception {
	...
	Configuration conf = new Configuration();
		...
		FileInputFormat.setInputPaths(job, new Path("D:\\transferStation\\tmp\\url\\countout"));
		FileOutputFormat.setOutputPath(job, new Path("D:\\transferStation\\tmp\\url\\sortout"));
